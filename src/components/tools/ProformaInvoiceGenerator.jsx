...
const InvoiceGenerator = () => {
  ...
  const [meta, setMeta] = useState({
    invoiceNo: `SFPI-${new Date().getMonth()+1}${new Date().getFullYear().toString().slice(-2)}-${Math.floor(1000 + Math.random() * 9000)}`,
    ...
    <div className="p-4 lg:p-8 bg-stone-50 min-h-screen">
      ...
      <div className="print:hidden max-w-5xl mx-auto mb-10 bg-white p-8 rounded-[40px] shadow-sm border border-stone-100">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-2xl font-black text-stone-800">Proforma Invoice Generator</h1>
